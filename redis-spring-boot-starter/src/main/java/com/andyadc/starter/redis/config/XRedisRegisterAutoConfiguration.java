package com.andyadc.starter.redis.config;

import com.andyadc.starter.redis.annotation.XRedis;
import com.andyadc.starter.redis.reflect.XRedisFactoryBean;
import com.andyadc.starter.redis.util.SimpleMetadataReader;
...
public class XRedisRegisterAutoConfiguration implements InitializingBean {
    ...
    private static final Logger logger = LoggerFactory.getLogger(XRedisRegisterAutoConfiguration.class);
